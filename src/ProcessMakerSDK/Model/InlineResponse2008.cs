...
namespace ProcessMakerSDK.Model
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Display a listing of groups available.</param>
        /// <param name="meta">meta.</param>
        public InlineResponse2008(List<GroupMembers> data = default(List<GroupMembers>), Metadata meta = default(Metadata))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>Display a listing of groups available</value>
