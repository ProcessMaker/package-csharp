...
namespace ProcessMakerSDK.Model
{
    ...
    public partial class InlineResponse20015 :  IEquatable<InlineResponse20015>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Display a listing of the Screen Categories..</param>
        /// <param name="meta">Display a listing of the Screen Categories..</param>
        public InlineResponse20015(List<ScreenCategory> data = default(List<ScreenCategory>), Metadata meta = default(Metadata))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>Display a listing of the Screen Categories.</value>
        [DataMember(Name="data", EmitDefaultValue=false)]
        public List<ScreenCategory> Data { get; set; }
