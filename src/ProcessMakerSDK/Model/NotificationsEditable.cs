...
namespace ProcessMakerSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NotificationsEditable :  IEquatable<NotificationsEditable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationsEditable" /> class.
        /// </summary>
        ...
        public NotificationsEditable(string id = default(string), string type = default(string), string notifiableType = default(string), int? notifiableId = default(int?), string data = default(string))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as NotificationsEditable);
        }

        /// <summary>
        /// Returns true if NotificationsEditable instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationsEditable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationsEditable input)
        {
            if (input == null)
                return false;
