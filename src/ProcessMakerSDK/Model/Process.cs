...
namespace ProcessMakerSDK.Model
{
    ...
    public partial class Process :  IEquatable<Process>, IValidatableObject
    {
        ...
        public Process(string processCategoryId = default(string), string name = default(string), string description = default(string), StatusEnum? status = default(StatusEnum?), string userId = default(string), string id = default(string), DateTime? createdAt = default(DateTime?), DateTime? updatedAt = default(DateTime?))
        {
