...
namespace ProcessMakerSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskAssignments :  IEquatable<TaskAssignments>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskAssignments" /> class.
        /// </summary>
        ...
        public TaskAssignments(string id = default(string), string processId = default(string), string processTaskId = default(string), string assignmentId = default(string), AssignmentTypeEnum? assignmentType = default(AssignmentTypeEnum?))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TaskAssignments);
        }

        /// <summary>
        /// Returns true if TaskAssignments instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskAssignments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskAssignments input)
        {
            if (input == null)
                return false;
