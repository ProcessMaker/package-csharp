...
namespace ProcessMakerSDK.Model
{
    ...
    public partial class InlineResponse20016 :  IEquatable<InlineResponse20016>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Get a list of Screens..</param>
        /// <param name="meta">Get a list of Screens..</param>
        public InlineResponse20016(List<Screens> data = default(List<Screens>), Metadata meta = default(Metadata))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>Get a list of Screens.</value>
        [DataMember(Name="data", EmitDefaultValue=false)]
        public List<Screens> Data { get; set; }
