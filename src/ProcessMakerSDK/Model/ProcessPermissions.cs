...
namespace ProcessMakerSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProcessPermissions :  IEquatable<ProcessPermissions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessPermissions" /> class.
        /// </summary>
        ...
        public ProcessPermissions(int? id = default(int?), int? processId = default(int?), int? permissionId = default(int?), int? assignableId = default(int?), string assignableType = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ProcessPermissions);
        }

        /// <summary>
        /// Returns true if ProcessPermissions instances are equal
        /// </summary>
        /// <param name="input">Instance of ProcessPermissions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessPermissions input)
        {
            if (input == null)
                return false;
