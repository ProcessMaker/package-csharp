...
namespace ProcessMakerSDK.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Display a listing of users available.</param>
        /// <param name="meta">meta.</param>
        public InlineResponse2009(List<GroupMembers> data = default(List<GroupMembers>), Metadata meta = default(Metadata))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>Display a listing of users available</value>
