...
namespace ProcessMakerSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CommentsEditable :  IEquatable<CommentsEditable>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommentsEditable" /> class.
        /// </summary>
        ...
        public CommentsEditable(string id = default(string), string userId = default(string), string commentableId = default(string), string commentableType = default(string), string subject = default(string), string body = default(string), bool? hidden = default(bool?), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.UserId = userId;
        ...
        {
            return this.Equals(input as CommentsEditable);
        }

        /// <summary>
        /// Returns true if CommentsEditable instances are equal
        /// </summary>
        /// <param name="input">Instance of CommentsEditable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommentsEditable input)
        {
            if (input == null)
                return false;
