...
namespace ProcessMakerSDK.Model
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        /// <param name="meta">Display a listing of the resource..</param>
        public InlineResponse20010(List<Notifications> data = default(List<Notifications>), Metadata meta = default(Metadata))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<Notifications> Data { get; set; }
