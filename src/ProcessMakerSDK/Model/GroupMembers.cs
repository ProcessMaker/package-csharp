...
namespace ProcessMakerSDK.Model
{
    ...
    public partial class GroupMembers :  IEquatable<GroupMembers>, IValidatableObject
    {
        ...
        public GroupMembers(string id = default(string), string groupId = default(string), string memberId = default(string), string memberType = default(string), string description = default(string), StatusEnum? status = default(StatusEnum?), DateTime? createdAt = default(DateTime?), DateTime? updatedAt = default(DateTime?))
        {
            this.Id = id;
