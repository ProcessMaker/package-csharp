...
namespace ProcessMakerSDK.Model
{
    ...
    public partial class InlineResponse20013 :  IEquatable<InlineResponse20013>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Returns the list of processes that the user can start..</param>
        /// <param name="meta">meta.</param>
        public InlineResponse20013(List<ProcessWithStartEvents> data = default(List<ProcessWithStartEvents>), Metadata meta = default(Metadata))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>Returns the list of processes that the user can start.</value>
        [DataMember(Name="data", EmitDefaultValue=false)]
        public List<ProcessWithStartEvents> Data { get; set; }
