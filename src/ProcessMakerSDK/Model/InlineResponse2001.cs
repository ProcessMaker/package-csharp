...
namespace ProcessMakerSDK.Model
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Fetch a collection of variables based on paged request and filter if provided.</param>
        /// <param name="meta">Fetch a collection of variables based on paged request and filter if provided.</param>
        public InlineResponse2001(List<EnvironmentVariables> data = default(List<EnvironmentVariables>), Metadata meta = default(Metadata))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>Fetch a collection of variables based on paged request and filter if provided</value>
        [DataMember(Name="data", EmitDefaultValue=false)]
        public List<EnvironmentVariables> Data { get; set; }
