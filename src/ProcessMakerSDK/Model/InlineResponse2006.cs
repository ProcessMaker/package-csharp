...
namespace ProcessMakerSDK.Model
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Display the list of users in a group.</param>
        /// <param name="meta">meta.</param>
        public InlineResponse2006(List<Users> data = default(List<Users>), Metadata meta = default(Metadata))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>Display the list of users in a group</value>
