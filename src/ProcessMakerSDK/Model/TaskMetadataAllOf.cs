...
namespace ProcessMakerSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskMetadataAllOf :  IEquatable<TaskMetadataAllOf>, IValidatableObject
    {
        /// <summary>
        /// Defines SortOrder
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskMetadataAllOf" /> class.
        /// </summary>
        ...
        public TaskMetadataAllOf(string filter = default(string), string sortBy = default(string), SortOrderEnum? sortOrder = default(SortOrderEnum?), int? count = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? form = default(int?), int? lastPage = default(int?), string path = default(string), int? perPage = default(int?), int? to = default(int?), int? total = default(int?), int? inOverdue = default(int?))
        {
            this.Filter = filter;
            this.SortBy = sortBy;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskMetadataAllOf {\n");
        ...
        {
            return this.Equals(input as TaskMetadataAllOf);
        }

        /// <summary>
        /// Returns true if TaskMetadataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskMetadataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskMetadataAllOf input)
        {
            if (input == null)
                return false;
