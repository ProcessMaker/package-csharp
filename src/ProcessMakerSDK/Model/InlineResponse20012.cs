...
namespace ProcessMakerSDK.Model
{
    ...
    public partial class InlineResponse20012 :  IEquatable<InlineResponse20012>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Get list Process.</param>
        /// <param name="meta">meta.</param>
        public InlineResponse20012(List<Process> data = default(List<Process>), Metadata meta = default(Metadata))
        {
            this.Data = data;
            this.Meta = meta;
        }
