...
namespace ProcessMakerSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsersEditable :  IEquatable<UsersEditable>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersEditable" /> class.
        /// </summary>
        ...
        public UsersEditable(string email = default(string), string password = default(string), string firstname = default(string), string lastname = default(string), string username = default(string), string address = default(string), string city = default(string), string state = default(string), string postal = default(string), string country = default(string), string phone = default(string), string fax = default(string), string cell = default(string), string title = default(string), string timezone = default(string), string datetimeFormat = default(string), string language = default(string), bool? isAdministrator = default(bool?), string loggedinAt = default(string), StatusEnum? status = default(StatusEnum?))
        {
            this.Email = email;
        ...
        {
            return this.Equals(input as UsersEditable);
        }

        /// <summary>
        /// Returns true if UsersEditable instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersEditable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersEditable input)
        {
            if (input == null)
                return false;
