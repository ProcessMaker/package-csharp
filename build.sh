...
${nuget_cmd} install src/ProcessMakerSDK/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/ProcessMakerSDK.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/ProcessMakerSDK.dll \
-recurse:'src/ProcessMakerSDK/*.cs' \
-doc:bin/ProcessMakerSDK.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/ProcessMakerSDK.dll was created successfully"
fi
